...
class ProductsApiController extends Controller
{
     ...
     * @return JsonResponse
     */
    public function createProduct( CreateProduct $request): JsonResponse
    {
        ...
        if ($newProduct) {
            ...
            try {
                ...
                // Log errors
                Log::info('Guzzle Error' . $exceptionn->getMessage() );
                // Return response
                return response()->json(['status' => 'failed', 'data' => '', 'message' => $exceptionn->getMessage() ], 200);
            }
        }
        // Return response
